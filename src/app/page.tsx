...
import book from "../../sanity/schemas/project-schemas";
...
export default async function Home() {
  ...
  return (
    <div>
      ...
      <p className="mt-3 text-xl text-gray-600">Hello everyone! Check out my books!</p>
      ...
      <div className="mt-5 grid md:grid-cols-2 lg:grid-cols-3 gap-8">{projects.map((book) => (
        <div key={book._id} className="border-2 border-gray-500 rounded-lg p-1 hover:scale-105 hover:border-blue-500 transition">
          {book.image && (
            <Image
              src={book.image}
              alt={book.name}
